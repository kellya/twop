...
def _init_config():
    ...
    config['openproject']['baseUrl'] = input("OpenProject Site: ")
    config['openproject']['apiKey'] = input("Your API key: ")
    
    op = openproject(config['openproject']['baseUrl'],config['openproject']['apiKey'])
    me = op.whoami()
    print (me)
    
    config['openproject']['userId'] = me
